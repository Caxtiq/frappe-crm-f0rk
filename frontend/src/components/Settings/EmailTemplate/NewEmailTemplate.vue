<template>
  <div class="new-email-template-page flex h-full flex-col gap-6 p-8 text-ink-gray-8">
    <!-- Header -->
    <div class="new-email-template-head flex justify-between">
    ...
    <!-- Fields -->
    <div class="new-email-template-body flex flex-1 flex-col gap-4 overflow-y-auto">
