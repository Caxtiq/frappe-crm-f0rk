<template>
  <div class="email-templates-page flex h-full flex-col gap-6 p-6 text-ink-gray-8">
    <!-- Header -->
    <div class="email-templates-head flex justify-between px-2 pt-2">
    ...
    <!-- Email template list -->
    <div
      class="email-templates-body flex flex-col overflow-hidden"
